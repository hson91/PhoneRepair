...
class ConfigsappsController extends AController
{
	/**
	...
	public function actionIndex()
	{
        ...
        $model=new ConfigsApp('search');
        $model->unsetAttributes();
        if(isset($_GET['ConfigsApp']))
            $model->attributes = $_GET['ConfigsApp'];
    ...
    public function actionCreate(){
        ...
        $model = new ConfigsApp();
        if(isset($_POST['ConfigsApp'])){
			$model->attributes=$_POST['ConfigsApp'];
            if($model->validate()){
                $model->save();
	...
	{
		$model = ConfigsApp::model()->findByPk($id);
		if($model===null)
